...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        getObjectUUID, initObjectPicking, isObjectAmongObjects, retrieveObjectNames,
...
registerOnClick('Grid', false, false, [0,1,2], false, function(event) {
    if (pagina == '0') {
        operateAnimation('PLAY', 'vacio', 1, 80, 'LoopOnce', 1, function() {
            pagina = '1';
        }, false);
    } else if (pagina == '1') {
        operateAnimation('PLAY', 'vacio', 1, 80, 'LoopOnce', 1, function() {
...
registerOnClick('Grid.001', false, false, [0,1,2], false, function(event) {
    if (pagina == '1') {
        operateAnimation('PLAY', 'vacio.001', 80, 160, 'LoopOnce', 1, function() {
            pagina = '2';
        }, false);
    } else if (pagina == '2') {
        operateAnimation('PLAY', 'vacio.001', 80, 160, 'LoopOnce', 1, function() {
...
registerOnClick('Grid.002', false, false, [0,1,2], false, function(event) {
    if (pagina == '2') {
        operateAnimation('PLAY', 'vacio.002', 160, 240, 'LoopOnce', 1, function() {
            pagina = '3';
        }, false);
    } else if (pagina == '3') {
        operateAnimation('PLAY', 'vacio.002', 160, 240, 'LoopOnce', 1, function() {
...
operateAnimation('STOP', 'Hoja 1', null, null, 'AUTO', 1, function() {}, false);
operateAnimation('STOP', 'Hoja 2', null, null, 'AUTO', 1, function() {}, false);
operateAnimation('STOP', 'Hoja 3', null, null, 'AUTO', 1, function() {}, false);
operateAnimation('STOP', 'vacio', null, null, 'AUTO', 1, function() {}, false);
operateAnimation('STOP', 'vacio.001', null, null, 'AUTO', 1, function() {}, false);
operateAnimation('STOP', 'vacio.002', null, null, 'AUTO', 1, function() {}, false);

pagina = '0';

registerOnClick('Cylinder', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam01', 'camlookup1', 1, function() {}, 1);
}, function(event) {});

registerOnClick('Grid', false, false, [0,1,2], false, function(event) {
    if (pagina == '0') {
        operateAnimation('PLAY', 'Hoja 1', 1, 80, 'LoopOnce', 1, function() {
            pagina = '1';
        }, false);
    } else if (pagina == '1') {
        operateAnimation('PLAY', 'Hoja 1', 1, 80, 'LoopOnce', 1, function() {
...
registerOnClick('Grid.001', false, false, [0,1,2], false, function(event) {
    if (pagina == '1') {
        operateAnimation('PLAY', 'Hoja 2', 80, 160, 'LoopOnce', 1, function() {
            pagina = '2';
        }, false);
    } else if (pagina == '2') {
        operateAnimation('PLAY', 'Hoja 2', 80, 160, 'LoopOnce', 1, function() {
...
registerOnClick('Grid.002', false, false, [0,1,2], false, function(event) {
    if (pagina == '2') {
        operateAnimation('PLAY', 'Hoja 3', 160, 240, 'LoopOnce', 1, function() {
            pagina = '3';
        }, false);
    } else if (pagina == '3') {
        operateAnimation('PLAY', 'Hoja 3', 160, 240, 'LoopOnce', 1, function() {
